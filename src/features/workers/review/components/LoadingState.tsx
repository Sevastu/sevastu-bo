    ...
    return (
        <div className="p-6 space-y-6 animate-pulse max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-center mb-8">
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-2">
                        <div className="w-48 h-6 bg-muted rounded-md" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-6">
                ...
                <div className="bg-card p-6 rounded-2xl border border-border h-64">
                    <div className="w-48 h-5 bg-muted rounded-md mb-8" />
            ...
            <div className="grid grid-cols-4 gap-4">
                {[...Array(4)].map((_, i) => (
                    <div key={i} className="h-28 bg-card border border-border rounded-2xl p-5">
                        <div className="w-20 h-4 bg-muted rounded-md mb-4" />
