...
export const WorkerVerificationCardSkeleton = memo(function WorkerVerificationCardSkeleton() {
  return (
    <div className="bg-card rounded-2xl p-6 border border-border shadow-sm animate-pulse flex flex-col h-full">
      {/* Header */}
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-muted shrink-0 border border-border" />
        ...
        <div className="space-y-2 text-right">
          <div className="h-6 bg-muted rounded-md w-16 ml-auto" />
      ...
      {/* Services */}
      <div className="mb-6">
        <div className="h-4 bg-muted rounded-md w-16 mb-3" />
      ...
      <div className="mb-6 space-y-3">
        ...
        <div className="h-16 bg-muted rounded-xl border border-border" />
      </div>
