...
export const WorkerVerificationCard = memo(function WorkerVerificationCard({
  ...
  return (
    <div className="bg-card rounded-lg p-6 border border-border/20 shadow-sm  overflow-hidden hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-out flex flex-col h-full">
      {/* Header */}
