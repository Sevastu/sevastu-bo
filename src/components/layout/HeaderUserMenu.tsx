    ...
    return (
        <div className="relative border-l pl-2 lg:pl-4" ref={menuRef}>
            <button
                ...
                className="flex items-center gap-2 hover:bg-muted/50 p-1 pr-3 rounded-full transition-colors"
                aria-haspopup="true"
                aria-expanded={isOpen}
            >
                <div className="h-9 w-9 lg:h-10 lg:w-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-semibold shrink-0 shadow-sm">
                    {initial}
                </div>
