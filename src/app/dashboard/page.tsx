        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                    <h1 className="mt-2 text-3xl font-bold tracking-tight text-foreground">Marketplace Overview</h1>
                    <p className="text-muted-foreground">Overview of your service marketplace operations</p>
                </div>
